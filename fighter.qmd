...
selected_columns <- ufc %>%
  select(height_cm, weight_in_kg, reach_in_cm, significant_strikes_landed_per_minute,
...
model1 <- lm(win_ratio ~ stance + average_takedowns_landed_per_15_minutes + significant_striking_accuracy +
...
model2 <- glm(win_ratio_binary ~ stance + average_takedowns_landed_per_15_minutes + 
