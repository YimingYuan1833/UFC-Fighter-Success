...
model2 <- lm(win_ratio ~ age + stance + average_takedowns_landed_per_15_minutes + significant_striking_accuracy +
...
```{r ch-7, message - F}
#ordinal classified by win ratio
